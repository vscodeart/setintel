                ...
                @else
                    <div
                        ...
                        <div id="div2" class="hidden flex-grow pb-3.5">
                            <div
                                class="rounded-[10px]  w-11/12 m-auto bg-red-900 flex flex-col h-full flex-grow mb-3.5">
                                <div class="p-5">
                                    <div class="mb-3 font-normal text-white  h-[290px] overflow-hidden">
                                        {!! $service->content !!}
                                    </div>
                                </div>
                                <div class="h-full flex flex-col center">
                        ...
                        <div id="div1" class="block">
                            ...
                            <div class="pt-5 w-10/12 m-auto  ">
                                <div class="mb-3 font-normal text-gray-700 dark:text-gray-400 h-[115px] overflow-hidden">
                                    {!! $service->content !!}
                                </div>
                                <div class="pb-5 pt-5">
                                    <button onclick="toggleDivs()">
