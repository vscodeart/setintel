        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mx-5 lg:mx-0">
            ...
            @if(count($partners))
                @foreach($partners as $partner)
                    <div class="bg-white border-2 border-red-900 shadow-lg rounded-lg flex flex-col justify-between">
...
{{--                            <img src="{{ getImageUriCropped($partner, 'image' )  }}" class="object-cover  w-[200px]" />--}}
                        ...
                        <div class="bg-red-900 w-full pt-4 pb-4 flex items-center justify-center">
